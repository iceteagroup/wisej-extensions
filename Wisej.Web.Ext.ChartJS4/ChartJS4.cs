...
namespace Wisej.Web.Ext.ChartJS4
{
	...
	{
		/// <summary>
		/// Constructs a new instance of the <see cref="T:Wisej.Web.Ext.ChartJS4.ChartJS4"/> control.
		/// </summary>
		public ChartJS4()
		{
		}
		...
		/// <summary>
		/// Fires the <see cref="E:Wisej.Web.Ext.ChartJS4.ChartJS.ChartClick"/> event.
		/// </summary>
		/// <param name="e"></param>
		...
		/// <summary>
		/// Returns or sets the <see cref="Wisej.Web.Ext.ChartJS4.ChartType"/>.
		/// </summary>
		[DesignerActionList]
		...
		/// <summary>
		/// Chart options specific for the value of <see cref="P:Wisej.Web.Ext.ChartJS4.ChartJS.ChartType"/>.
		/// </summary>
		[DefaultValue(null)]
		...
		/// <summary>
		/// Returns or sets the list of plugin packages to load.
		/// </summary>
		[Description("Returns or sets the list of plugin packages to load.")]
		public static List<Package> PluginPackages
		{
			get
			{
			...
			set
			{
				_pluginPackages = value;

			}
		}
		private static List<Package> _pluginPackages = new List<Package>();

		/// <summary>
		/// Returns or sets the list of plugin packages to load.
		/// </summary>
		[Description("Returns or sets the list of plugin packages to load.")]
		public static List<Package> DataAdaptersPackages
		{
			get
			{
				return _dataAdaptersPackages;
			}
			set
			{
				_dataAdaptersPackages = value;

			}
		}
		private static List<Package> _dataAdaptersPackages = null;
		...
		public override List<Package> Packages
		{
			...
			get
			{
				if (base.Packages.Count == 0)
				{
					...
					// initialize the loader with the optional libraries.
					if (PluginPackages != null)
						base.Packages.AddRange(PluginPackages);

					// initialize the loader with the optional data adapters.
					if (DataAdaptersPackages != null)
						base.Packages.AddRange(DataAdaptersPackages);
				}
		...
		private Options CreateOptions()
		{
			switch (this.ChartType)
			{
				...
				case ChartType.Custom:
					return new CustomOptions(this, this._options);
		...
		protected override void OnWebRender(dynamic config)
		{
			base.Options = new
			{
				widgetFunctions = this.WidgetFunctions,
				type = this.ChartType,
