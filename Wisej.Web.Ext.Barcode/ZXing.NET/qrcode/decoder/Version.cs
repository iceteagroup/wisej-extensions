...
namespace ZXing.QrCode.Internal
{
   ...
   public sealed class Version
   {
      ...
      /// <summary>
      /// Returns the dimension for version.
      /// </summary>
      ...
      /// <summary>
      /// Returns the EC blocks for level.
      /// </summary>
      ...
      /// <summary>
      /// Returns the version for number.
      /// </summary>
      ...
      public sealed class ECBlocks
      {
         ...
         /// <summary>
         /// Returns the EC codewords per block.
         /// </summary>
         ...
         /// <summary>
         /// Returns the total EC codewords.
         /// </summary>
