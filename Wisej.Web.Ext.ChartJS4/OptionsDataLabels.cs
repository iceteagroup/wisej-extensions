...
namespace Wisej.Web.Ext.ChartJS4
{
	...
	public class OptionsDataLabels : OptionsBase
	{
		...
		/// <summary>
		/// Constructs a new instance of the <see cref="T:Wisej.Web.Ext.ChartJS4.OptionsDataLabel"/> set.
		/// </summary>
		...
		/// <summary>
		/// You can define multiple labels for each data element using the labels option.
		/// This option is an object where each property represents a new label, the key being 
		/// the label key and the value being the options specific to each label. 
		/// </summary>
		[Description("Allows you to define multiple labels for each data element")]
		...
		/// <summary>
		/// Listeners lets you attach callbacks that run when specific events happen.
		/// This option is an object where each property represents an event, the key being 
		/// the type of the event to listen and the value being a callback accepting the context and event arguments.
		/// </summary>
		[Description("Listeners lets you attach callbacks that run when specific events happen.")]
