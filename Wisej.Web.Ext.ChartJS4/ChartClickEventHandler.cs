...
namespace Wisej.Web.Ext.ChartJS4
{
	...
	/// <summary>
	/// Represents the method that will handle the <see cref="E:Wisej.Web.Ext.ChartJS4.ChartJS.ChartClick" /> event in a <see cref="T:Wisej.Web.Ext.ChartJS4.ChartJS4"/>.
	/// </summary>
	/// <param name="sender">The source of the event. </param>
	/// <param name="e">A <see cref="T:Wisej.Web.Ext.ChartJS4.ChartClickEventArgs" /> that contains the event data. </param>
	public delegate void ChartClickEventHandler(object sender, ChartClickEventArgs e);

	/// <summary>
	/// Provides data for the <see cref="E:Wisej.Web.Ext.ChartJS4.ChartJS.ChartClick" /> event of the <see cref="T:Wisej.Web.Ext.ChartJS4.ChartJS4" /> control.
	/// </summary>
	public class ChartClickEventArgs: EventArgs
	{
		/// <summary>
		///  Constructs a new instance of <see cref="T:Wisej.Web.Ext.ChartJS4.ChartClickEventArgs"/>.
		/// </summary>
