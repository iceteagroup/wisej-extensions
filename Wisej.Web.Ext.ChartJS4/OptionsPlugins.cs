...
namespace Wisej.Web.Ext.ChartJS4
{
	...
	public class OptionsPlugins : OptionsBase
	{
		...
		/// <summary>
		/// Constructs a new instance of the <see cref="T:Wisej.Web.Ext.ChartJS4.OptionsPlugins"/> set.
		/// </summary>
		...
		/// <summary>
		/// Options for the chart filler.
		/// </summary>
		[Description("Options for the chart filler.")]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		public OptionsFiller Filler
		{
			get
			{
				if (this._filler == null)
					this._filler = new OptionsFiller(this);
				return this._filler;
			}
			set
			{
		...
		private OptionsFiller _filler;

		/// <summary>
		/// Custom options for plugins.
		/// </summary>
		[Description("Custom options for plugins")]
