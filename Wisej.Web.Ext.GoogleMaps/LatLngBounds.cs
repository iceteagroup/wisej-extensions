...
{
	/// <summary>
	/// A LatLngBounds is a point in geographical coordinates: latitude and longitude.
	/// </summary>
	/// <remarks>
	/// 
	...
	/// Notice that you cannot modify the coordinates of a LatLngBounds. If you want to compute another point, you have to create a new one.
	/// 
	/// </remarks>
	public class LatLngBounds
	{
		...
		internal LatLngBounds(double lat, double lng)
		{
			this.Lat = lat;
			this.Lng = lng;
		}
