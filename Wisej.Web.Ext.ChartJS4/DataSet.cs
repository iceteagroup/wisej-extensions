...
{
	/// <summary>
	/// Represents the data used by the <see cref="T: Wisej.Web.Ext.ChartJS4.ChartJS4"/> control to plot the chart.
	...
	{
		/// <summary>
		/// Constructs a new instance of <see cref="T:Wisej.Web.Ext.ChartJS4.DataSet"/>.
		/// </summary>
		public DataSet()
		{
			this.Label = "Data Set";
		...
		/// <summary>
		/// Returns the type of chart that plots this type of <see cref="T:Wisej.Web.Ext.ChartJS4.DataSet"/>.
		/// </summary>
	...
	/// <summary>
	/// Specialized data set for the <see cref="F:Wisej.Web.Ext.ChartJS4.ChartType.Line"/> chart.
	/// </summary>
	public class LineDataSet : DataSet
	{
		/// <summary>
		/// Constructs a new instance of <see cref="T:Wisej.Web.Ext.ChartJS4.LineDataSet"/>.
		/// </summary>
		public LineDataSet() : base()
		{
			...
			this.PointStyle = new PointStyle[] { Ext.ChartJS4.PointStyle.Circle };
		}
		...
		/// <summary>
		/// Used to create space between two datasets or a dataset and a boundary, i.e. the scale origin, start, or end
		/// </summary>
		[DefaultValue(false)]
		[Description("Used to create space between two datasets or a dataset and a boundary, i.e. the scale origin, start, or end")]
		public object Fill
		{
			get;
			set;
		...
		/// </summary>
		[DefaultValue(1)]
		[Description("Bezier curve tension of the line.")]
		...
		/// </summary>
		[DefaultValue(new PointStyle[] { Wisej.Web.Ext.ChartJS4.PointStyle.Circle })]
		[MergableProperty(false)]
	...
	/// <summary>
	/// Specialized data set for the <see cref="F:Wisej.Web.Ext.ChartJS4.ChartType.Scatter"/> chart.
	/// </summary>
	public class ScatterDataSet : DataSet
	{
		/// <summary>
		/// Constructs a new instance of <see cref="T:Wisej.Web.Ext.ChartJS4.ScatterDataSet"/>.
		/// </summary>
		public ScatterDataSet() : base()
		{
			this.Fill = false;
			this.ShowLine = false; //true for Line but false for scatter
			this.BorderWidth = 3;
			this.SpanGaps = false;
			this.Type = ChartType.Line;
			this.Stepped = SteppedLine.False;
	...
	/// <summary>
	/// Specialized data set for the <see cref="F:Wisej.Web.Ext.ChartJS4.ChartType.Bar"/> chart.
	/// </summary>
	public class BarDataSet : DataSet
	{
		/// <summary>
		/// Constructs a new instance of <see cref="T:Wisej.Web.Ext.ChartJS4.BarDataSet"/>.
		/// </summary>
		...
		[Editor("System.ComponentModel.Design.ArrayEditor, System.Design, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a",
				"System.Drawing.Design.UITypeEditor, System.Drawing, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
		public new object BackgroundColor
		{
			get;
			set;
		}
		...
		/// <summary>
		/// The border radius of the data set. It is applied to all corners of the rectangle 
		/// (topLeft, topRight, bottomLeft, bottomRight), except corners touching the borderSkipped.
		/// </summary>
		[MergableProperty(false)]
		[Description("The Border Radius of the data set")]
		[DefaultValue(0)]
		...
		/// <summary>
		/// Used to avoid drawing the bar stroke at the base of the fill, or disable the border radius.
		/// </summary>
		[MergableProperty(true)]
		[Description("Used to avoid drawing the bar stroke at the base of the fill, or disable the border radius.")]
		[DefaultValue(true)]
		public bool BorderSkipped
		{
			get
			{
				return this._borderSkipped;
			}
			set
			{
				if (value != this._borderSkipped)
				{
					this._borderSkipped = value;
				}
			}
		}
		private bool _borderSkipped = true;
	...
	/// <summary>
	/// Specialized data set for the <see cref="F:Wisej.Web.Ext.ChartJS4.ChartType.HorizontalBar"/> chart.
	/// </summary>
	public class HorizontalBarDataSet : BarDataSet
	{
		/// <summary>
		/// Constructs a new instance of <see cref="T:Wisej.Web.Ext.ChartJS4.HorizontalBarDataSet"/>.
		/// </summary>
	...
	/// <summary>
	/// Specialized data set for the <see cref="F:Wisej.Web.Ext.ChartJS4.ChartType.Doughnut"/> chart.
	/// </summary>
	public class DoughnutDataSet : DataSet
	{
		/// <summary>
		/// Constructs a new instance of <see cref="T:Wisej.Web.Ext.ChartJS4.DoughnutDataSet"/>.
		/// </summary>
	...
	/// <summary>
	/// Specialized data set for the <see cref="F:Wisej.Web.Ext.ChartJS4.ChartType.Pie"/> chart.
	/// </summary>
	public class PieDataSet : DataSet
	{
		/// <summary>
		/// Constructs a new instance of <see cref="T:Wisej.Web.Ext.ChartJS4.PieDataSet"/>.
		/// </summary>
	...
	/// <summary>
	/// Specialized data set for the <see cref="F:Wisej.Web.Ext.ChartJS4.ChartType.PolarArea"/> chart.
	/// </summary>
	public class PolarAreaDataSet : DataSet
	{
		/// <summary>
		/// Constructs a new instance of <see cref="T:Wisej.Web.Ext.ChartJS4.PolarAreaDataSet"/>.
		/// </summary>
	...
	/// <summary>
	/// Specialized data set for the <see cref="F:Wisej.Web.Ext.ChartJS4.ChartType.Radar"/> chart.
	/// </summary>
	public class RadarDataSet : DataSet
	{
		/// <summary>
		/// Constructs a new instance of <see cref="T:Wisej.Web.Ext.ChartJS4.RadarDataSet"/>.
		/// </summary>
		...
		/// <summary>
		///	Fill can be used to create space between two datasets or a dataset and a boundary
		/// </summary>
		[Description("Fill can be used to create space between two datasets or a dataset and a boundary")]
		[MergableProperty(false)]
		public object Fill
		{
			get;
	...
	/// <summary>
	/// Specialized data set for the <see cref="F:Wisej.Web.Ext.ChartJS4.ChartType.Bubble"/> chart.
	/// </summary>
	public class BubbleDataSet : DataSet
	{
		...
		/// <summary>
		/// The style of the box stroke.
		/// </summary>
		[DefaultValue("")]
		[Description("The style of the box stroke.")]
