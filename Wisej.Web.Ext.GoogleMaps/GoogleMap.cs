...
namespace Wisej.Web.Ext.GoogleMaps
{
    ...
    public class GoogleMap : Widget
    {
        ...
        public void GetMarkerGeocode(Action<GeocoderResult[]> callback, string markerId)
        {
            GetGeocodenCore(callback, markerId, null, null);
        }

        public void GetGeocode(Action<GeocoderResult[]> callback, string address)
        {
            GetGeocodenCore(callback, null, null, address);
        }

        public void GetGeocode(Action<GeocoderResult[]> callback, LatLng location)
        {
            GetGeocodenCore(callback, null, location, null);
        }


        public void GetGeocode(Action<GeocoderResult[]> callback, double lat, double lng)
        {
            GetGeocodenCore(callback, null, new LatLng(lat, lng), null);
        }

        // Implementation
        private void GetGeocodenCore(Action<GeocoderResult[]> callback, string markerId, LatLng location,
            string address)
        {
            ...
            if (!string.IsNullOrWhiteSpace(markerId))
                Call("getGeocode", id, markerId);
            else if (!string.IsNullOrWhiteSpace(address))
                Call("getGeocode", id, null, address);
            else
                Call("getGeocode", id, null, location);
        }
