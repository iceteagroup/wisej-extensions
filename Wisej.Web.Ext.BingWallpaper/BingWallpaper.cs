...
{
	/// <summary>
	/// Changes the wallpaper of the <see cref="T:Wisej.Web.Desktop"/> control to use
	/// Bing's image of the day.
	/// </summary>
	[ToolboxItem(true)]
	[ToolboxBitmap(typeof(BingWallpaper))]
	[SRDescription("Changes the wallpaper of the current Desktop control to use Bing's image of the day.")]
